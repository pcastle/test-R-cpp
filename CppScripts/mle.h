...
struct LMParams
{
    int max_iter = 1000;
    double tol = 1e-8;
    double lambda0 = 1e-3;   // λ inicial
    double lambda_up = 10.0; // factor de aumento si empeora
    double lambda_dn = 0.1;  // factor de reducción si mejora
    double lambda_max = 1e8; // límite superior de λ
};
